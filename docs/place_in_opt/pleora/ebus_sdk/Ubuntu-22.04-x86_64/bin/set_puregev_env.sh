...
export GENICAM_ROOT_V3_4=$GENICAM_ROOT
export GENICAM_LOG_CONFIG=$DIRNAME/lib/genicam/log/config/DefaultLogging.properties
export GENICAM_LOG_CONFIG_V3_4=$GENICAM_LOG_CONFIG
export GENICAM_CACHE_V3_4=$HOME/.config/Pleora/genicam_cache_v3_4
export GENICAM_CACHE=$GENICAM_CACHE_V3_4
