...
#define FILE_SELECTOR_ADDR ( 0x18000000 )
...
#define SAMPLEENUMCOUNT ( 3 )
#define SAMPLEENUMADDR ( 0x10000000 )
#define SAMPLEENUMNAME "SampleEnum"
#define SAMPLEENUMDESCRIPTION "Sample enum description. Selects both sample string and sample boolean."
#define SAMPLEENUMTOOLTIP "Sample enum."

#define SAMPLESTRINGADDR ( 0x10000010 )
#define SAMPLESTRINGNAME "SampleString"
#define SAMPLESTRINGDESCRIPTION "Sample string description. Cleared by sample command, selected by sample enum."
...
#define SAMPLEBOOLEANTOOLTIP "Sample Boolean. Selected by sample enum."

#define SAMPLECOMMANDADDR ( 0x10000030 )
#define SAMPLECOMMANDNAME "SampleCommand"
#define SAMPLECOMMANDDESCRIPTION "Sample command description. Clears sample string."
#define SAMPLECOMMANDTOOLTIP "Sample command."

#define SAMPLEINTEGERADDR ( 0x10000040 )
#define SAMPLEINTEGERNAME "SampleInteger"
#define SAMPLEINTEGERDESCRIPTION "Sample integer defined as milliseconds."
...
#define SAMPLEFLOATDESCRIPTION "Sample float defined as inches."
...
#define SOURCE0_BOOL_ADDR ( BASE_ADDR +  0x100 )
#define SOURCE0_INT_ADDR  ( BASE_ADDR +  0x104 ) 
...
#define TRIGGERSELECTOR_ADDR( a ) ( ( BASE_ADDR + 0x0060 ) + ( 0x10 * a ) )
#define TRIGGERMODE_ADDR( a ) ( ( BASE_ADDR + 0x0064 ) + ( 0x10 * a ) )
#define TRIGGERSOURCE_ADDR( a ) ( ( BASE_ADDR + 0x0068 ) + ( 0x10 * a ) )
#define TRIGGERSOFTWARE_ADDR( a ) ( ( BASE_ADDR + 0x006c ) + ( 0x10 * a ) )

//#define GEV_REG_VGEVD_TRIGGERSELECTOR( a ) (0x3FFE0048 + ( 0x80*a ))
//#define GEV_REG_VGEVD_TRIGGERMODE( a ) (0x3FFE004C + ( 0x80*a ))
//#define GEV_REG_VGEVD_TRIGGERSOURCE( a ) (0x3FFE0050 + ( 0x80*a ))
//#define GEV_REG_VGEVD_TRIGGERSOFTWARE( a ) (0x3FFE0054 + ( 0x80*a ))
