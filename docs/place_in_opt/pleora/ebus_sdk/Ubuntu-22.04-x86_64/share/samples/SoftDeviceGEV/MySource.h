...
public:
    ...
    PvResult GetGevSCPSPacketSizeInfo( uint32_t& aMax) const;
...
private:
    ...
    uint32_t mSource0OnlyInt;
    bool     mSource0OnlyBool;
    ...
    void CreateRegisters( IPvRegisterMap *aRegisterMap, 
		          IPvRegisterFactory *aFactory);

    void CreateGenApiFeatures ( IPvRegisterMap *aRegisterMap,
