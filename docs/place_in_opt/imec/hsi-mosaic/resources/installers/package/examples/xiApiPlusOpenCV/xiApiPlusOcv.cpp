...
//#include <xiAPIplus/xiapiplus.h>
	...
	// integer type
	int xiAPIplus_Camera::GetRegionSelector()
	{
		CheckCamHandle("GetRegionSelector");
		int val=0;
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_SELECTOR, &val);
		CheckResult(res,"GetRegionSelector");
		return val;	
	}
	int xiAPIplus_Camera::GetRegionSelector_Maximum()
	{		
		CheckCamHandle("GetRegionSelector" "_Maximum");
		int val=0;
		CheckCamHandle("GetRegionSelector");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_SELECTOR XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetRegionSelector" "_Maximum");
		return val;
	}
	
	int xiAPIplus_Camera::GetRegionSelector_Minimum()
	{
		CheckCamHandle("GetRegionSelector" "_Minimum");
		int val=0;
		CheckCamHandle("GetRegionSelector");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_SELECTOR XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetRegionSelector" "_Minimum");
		return val;
	}

	int xiAPIplus_Camera::GetRegionSelector_Increment()
	{
		CheckCamHandle("GetRegionSelector" "_Increment");
		int val=0;
		CheckCamHandle("GetRegionSelector");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_SELECTOR XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetRegionSelector" "_Increment");
		return val;		
	}
	
	void xiAPIplus_Camera::SetRegionSelector(int RegionSelector)
	{
		
		CheckCamHandleInt("SetRegionSelector",RegionSelector);
		
		XI_RETURN res=xiSetParamInt(camera_handle, XI_PRM_REGION_SELECTOR, RegionSelector);
		CheckResult(res,"SetRegionSelector");
	}
	 
	
	// Activates/deactivates Region selected by Region Selector (XI_PRM_REGION_MODE)
	// integer type
	int xiAPIplus_Camera::GetRegionMode()
	{
		CheckCamHandle("GetRegionMode");
		int val=0;
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_MODE, &val);
		CheckResult(res,"GetRegionMode");
		return val;	
	}
	int xiAPIplus_Camera::GetRegionMode_Maximum()
	{		
		CheckCamHandle("GetRegionMode" "_Maximum");
		int val=0;
		CheckCamHandle("GetRegionMode");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_MODE XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetRegionMode" "_Maximum");
		return val;
	}
	
	int xiAPIplus_Camera::GetRegionMode_Minimum()
	{
		CheckCamHandle("GetRegionMode" "_Minimum");
		int val=0;
		CheckCamHandle("GetRegionMode");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_MODE XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetRegionMode" "_Minimum");
		return val;
	}

	int xiAPIplus_Camera::GetRegionMode_Increment()
	{
		CheckCamHandle("GetRegionMode" "_Increment");
		int val=0;
		CheckCamHandle("GetRegionMode");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_REGION_MODE XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetRegionMode" "_Increment");
		return val;		
	}
	
	void xiAPIplus_Camera::SetRegionMode(int RegionMode)
	{
		
		CheckCamHandleInt("SetRegionMode",RegionMode);
		
		XI_RETURN res=xiSetParamInt(camera_handle, XI_PRM_REGION_MODE, RegionMode);
		CheckResult(res,"SetRegionMode");
	}
	...
	// integer type
	int xiAPIplus_Camera::GetAutoExposureAutoGainSkipFramesCount()
	{
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount");
		int val=0;
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_AEAG_SKIP_FRAMES_COUNT, &val);
		CheckResult(res,"GetAutoExposureAutoGainSkipFramesCount");
		return val;	
	}
	int xiAPIplus_Camera::GetAutoExposureAutoGainSkipFramesCount_Maximum()
	{		
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount" "_Maximum");
		int val=0;
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_AEAG_SKIP_FRAMES_COUNT XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetAutoExposureAutoGainSkipFramesCount" "_Maximum");
		return val;
	}
	
	int xiAPIplus_Camera::GetAutoExposureAutoGainSkipFramesCount_Minimum()
	{
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount" "_Minimum");
		int val=0;
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_AEAG_SKIP_FRAMES_COUNT XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetAutoExposureAutoGainSkipFramesCount" "_Minimum");
		return val;
	}

	int xiAPIplus_Camera::GetAutoExposureAutoGainSkipFramesCount_Increment()
	{
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount" "_Increment");
		int val=0;
		CheckCamHandle("GetAutoExposureAutoGainSkipFramesCount");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_AEAG_SKIP_FRAMES_COUNT XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetAutoExposureAutoGainSkipFramesCount" "_Increment");
		return val;		
	}
	
	void xiAPIplus_Camera::SetAutoExposureAutoGainSkipFramesCount(int AutoExposureAutoGainSkipFramesCount)
	{
		
		CheckCamHandleInt("SetAutoExposureAutoGainSkipFramesCount",AutoExposureAutoGainSkipFramesCount);
		
		XI_RETURN res=xiSetParamInt(camera_handle, XI_PRM_AEAG_SKIP_FRAMES_COUNT, AutoExposureAutoGainSkipFramesCount);
		CheckResult(res,"SetAutoExposureAutoGainSkipFramesCount");
	}
	...
	// GPI Level at image readout end (XI_PRM_GPI_LEVEL_AT_IMAGE_READOUT_END)
	// integer type
	int xiAPIplus_Camera::GetGPILevelAtImageReadoutEnd()
	{
		CheckCamHandle("GetGPILevelAtImageReadoutEnd");
		int val=0;
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_GPI_LEVEL_AT_IMAGE_READOUT_END, &val);
		CheckResult(res,"GetGPILevelAtImageReadoutEnd");
		return val;	
	}
	int xiAPIplus_Camera::GetGPILevelAtImageReadoutEnd_Maximum()
	{		
		CheckCamHandle("GetGPILevelAtImageReadoutEnd" "_Maximum");
		int val=0;
		CheckCamHandle("GetGPILevelAtImageReadoutEnd");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_GPI_LEVEL_AT_IMAGE_READOUT_END XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetGPILevelAtImageReadoutEnd" "_Maximum");
		return val;
	}
	
	int xiAPIplus_Camera::GetGPILevelAtImageReadoutEnd_Minimum()
	{
		CheckCamHandle("GetGPILevelAtImageReadoutEnd" "_Minimum");
		int val=0;
		CheckCamHandle("GetGPILevelAtImageReadoutEnd");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_GPI_LEVEL_AT_IMAGE_READOUT_END XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetGPILevelAtImageReadoutEnd" "_Minimum");
		return val;
	}

	int xiAPIplus_Camera::GetGPILevelAtImageReadoutEnd_Increment()
	{
		CheckCamHandle("GetGPILevelAtImageReadoutEnd" "_Increment");
		int val=0;
		CheckCamHandle("GetGPILevelAtImageReadoutEnd");
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_GPI_LEVEL_AT_IMAGE_READOUT_END XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetGPILevelAtImageReadoutEnd" "_Increment");
		return val;		
	}
	...
	// Defines metadata sampling mode (XI_PRM_METADATA_SAMPLING_MODE)
	XI_METADATA_SAMPLING_MODE xiAPIplus_Camera::GetMetadataSamplingMode()
	{
		int val=0;
		
		CheckCamHandle("GetMetadataSamplingMode");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_METADATA_SAMPLING_MODE, &val);
		CheckResult(res,"GetMetadataSamplingMode");
		return (XI_METADATA_SAMPLING_MODE)val;
	}
	
	XI_METADATA_SAMPLING_MODE xiAPIplus_Camera::GetMetadataSamplingMode_Maximum()
	{
		int val=0;
		
		CheckCamHandle("GetMetadataSamplingMode" "_Maximum");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_METADATA_SAMPLING_MODE XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetMetadataSamplingMode" "_Maximum");
		return (XI_METADATA_SAMPLING_MODE)val;
	}
	
	XI_METADATA_SAMPLING_MODE xiAPIplus_Camera::GetMetadataSamplingMode_Minimum()
	{
		int val=0;
		
		CheckCamHandle("GetMetadataSamplingMode" "_Minimum");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_METADATA_SAMPLING_MODE XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetMetadataSamplingMode" "_Minimum");
		return (XI_METADATA_SAMPLING_MODE)val;
	}
	
	int xiAPIplus_Camera::GetMetadataSamplingMode_Increment()
	{
		int val=0;
		
		CheckCamHandle("GetMetadataSamplingMode" "_Increment");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_METADATA_SAMPLING_MODE XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetMetadataSamplingMode" "_Increment");
		return val;
	}
	
	void xiAPIplus_Camera::SetMetadataSamplingMode(XI_METADATA_SAMPLING_MODE MetadataSamplingMode)
	{
		
		CheckCamHandleInt("SetMetadataSamplingMode",(int)MetadataSamplingMode);
		
		XI_RETURN res=xiSetParamInt(camera_handle, XI_PRM_METADATA_SAMPLING_MODE, MetadataSamplingMode);
		CheckResult(res,"SetMetadataSamplingMode");
	}
...
xiapi_errorcode_t xiAPIplus_errorcodes_list[]=
{
	XI_OK                             ,  "Function call succeeded",
		...
		XI_NOT_SUPPORTED_WHILE_ACQUISITION ,  "Parameter is not supported while acquisition is running.",
		...
		XIPR_IMAGE_CANT_PROCESSED_DUETO_WIDTH_ALIGNMENT,  "Image can't be processed due to image width alignment is not supported by Image Processor.",
...
void xiAPIplus_Enumerators::Init()
{
	...
	XI_RET_ITEMS.push_back({"XIPR_IMAGE_CANT_PROCESSED_DUETO_WIDTH_ALIGNMENT",1036, " Image can't be processed due to image width alignment is not supported by Image Processor."});
...
void xiAPIplusCameraOcv::resetCvImage_()
{
	...
	switch (next_image_->GetDataFormat())
	{
		...
		case XI_RAW16X3:
		{
			if ((((int)next_image_->GetWidth() *3) != cv_mat_image_.cols) || ((int)next_image_->GetHeight() != cv_mat_image_.rows))
				do_reset = true;
		}
		break;
		case XI_RAW8X4:
	...
	{		
		...
		switch( next_image_->GetDataFormat())
		{
			...
			case XI_RAW8X3		: cv_mat_image_.create(next_image_->GetHeight(), (next_image_->GetWidth()) * 3, CV_8UC1); printf("Doing reset to RAW\n"); break;
			...
			case XI_RAW16X3		: cv_mat_image_.create(next_image_->GetHeight(), (next_image_->GetWidth()) * 3, CV_16UC1); printf("Doing reset to RAW\n"); break;
