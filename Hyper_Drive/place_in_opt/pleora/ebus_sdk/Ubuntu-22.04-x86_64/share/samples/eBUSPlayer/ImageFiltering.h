...
class ImageFiltering : public Persistent
{
#ifdef _AFXDLL
...
public:
    ...
    PvBiColorFilterType GetBiColorFilter() const { return mBiColorFilter; }
    ...
    void SetBiColorFilter( PvBiColorFilterType aValue ) { mBiColorFilter = aValue; }
...
private:
    ...
    PvBiColorFilterType mBiColorFilter;
