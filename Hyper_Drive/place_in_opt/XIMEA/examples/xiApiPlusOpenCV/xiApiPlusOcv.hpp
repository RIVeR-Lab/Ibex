...
public:
	...
	*/
	...
	int GetGPILevelAtImageReadoutEnd();
	int GetGPILevelAtImageReadoutEnd_Maximum();
	int GetGPILevelAtImageReadoutEnd_Minimum();
	int GetGPILevelAtImageReadoutEnd_Increment(); 
	...
	XI_METADATA_SAMPLING_MODE GetMetadataSamplingMode();
	XI_METADATA_SAMPLING_MODE GetMetadataSamplingMode_Maximum();
	XI_METADATA_SAMPLING_MODE GetMetadataSamplingMode_Minimum();
	int GetMetadataSamplingMode_Increment();
	
	void SetMetadataSamplingMode(XI_METADATA_SAMPLING_MODE MetadataSamplingMode);
...
public:
	...
	std::vector<param_item_t> XI_IMAGE_SEQUENCE_TYPE_ITEMS;                           // Image sequence type.
	...
	std::vector<param_item_t> XI_METADATA_SAMPLING_MODE_ITEMS;                        // Metadata sampling mode selector
