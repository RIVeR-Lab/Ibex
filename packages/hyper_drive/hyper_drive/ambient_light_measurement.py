...
class LightMeasure(Node):
    def __init__(self):
        ...
        #raw data
        # White reference
        self.C_white_ximea = np.load(os.path.join(npy_path, 'vnir_white_ref.npy')).flatten()
        self.C_white_imec = np.load(os.path.join(npy_path, 'swir_white_ref.npy')).flatten()
        self.S_white_spectra = np.load(os.path.join(npy_path, 'point_spectra_white_ref.npy')).flatten()

        # Dark reference
        self.C_dark_ximea = np.load(os.path.join(npy_path, 'vnir_dark_ref.npy')).flatten()
        self.C_dark_imec = np.load(os.path.join(npy_path, 'swir_dark_ref.npy')).flatten()
